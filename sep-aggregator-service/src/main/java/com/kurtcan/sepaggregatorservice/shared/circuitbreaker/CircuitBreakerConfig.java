package com.kurtcan.sepaggregatorservice.shared.circuitbreaker;
...
public class CircuitBreakerConfig {
    ...
    public CircuitBreaker paymentServiceCircuitBreaker(Resilience4JCircuitBreakerFactory circuitBreakerFactory) {
