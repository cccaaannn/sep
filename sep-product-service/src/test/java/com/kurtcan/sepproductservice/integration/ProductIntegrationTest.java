...
public class ProductIntegrationTest {
        ...
        public void testGetProduct() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.get(MessageFormat.format("/products/{0}", product.getId())))
                                .andExpect(status().isOk())
        ...
        public void testGetProductNotFound() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.get(MessageFormat.format("/products/{0}", id)))
        ...
        public void testUpdateProduct() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.put(MessageFormat.format("/products/{0}", product.getId()))
                                .contentType(MediaType.APPLICATION_JSON)
        ...
        public void testUpdateProductNotFound() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.put(MessageFormat.format("/products/{0}", id))
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(objectMapper.writeValueAsString(productUpdate)))
                                .andExpect(status().isNotFound())
                                .andExpect(jsonPath("$.message").exists());
        ...
        public void testDeleteProduct() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.delete(MessageFormat.format("/products/{0}", product.getId())))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.message").exists());
        }
        ...
        public void testDeleteProductNotFound() throws Exception {
                ...
                // Then - Verify
                mockMvc.perform(MockMvcRequestBuilders.delete(MessageFormat.format("/products/{0}", id)))
                                .andExpect(status().isNotFound())
                                .andExpect(jsonPath("$.message").exists());
        }
